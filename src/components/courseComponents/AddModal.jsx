...
const AddModal = ({ batcheData, addCourseData, setAddCourseData, handler, loading }) => {
    ...
    return (<Modal id={"course_add_modal"} component={
        <div>
            ...
            <div className='flex flex-col gap-3 mt-4'>
                ...
                <button onClick={handler} className='btn btn-primary'>{!loading ? "Add Course" : <span className="loading loading-infinity loading-md"></span>}</button>
            </div>
        </div>}
    />)
}
